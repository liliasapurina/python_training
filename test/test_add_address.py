...
def test_add_address(app):
    ...
    current_address = Address(name="Maria",lastname="Olegovna",middlename="Vasnecova",nickname="OOMa",company="Pepsi",phone="3455566",mobilephone="347324",workphone="23545657",secondaryphone="66774")
